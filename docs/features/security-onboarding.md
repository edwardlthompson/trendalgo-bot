# Feature: security-onboarding

> Copy this file to `docs/features/security-onboarding.md` before Sprint 2+ work. Replace placeholders. Checklist markers: 🔲 open · ✅ done · ❌ blocked.
