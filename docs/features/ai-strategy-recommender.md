# Feature: ai-strategy-recommender

> Copy this file to `docs/features/ai-strategy-recommender.md` before Sprint 2+ work. Replace placeholders. Checklist markers: 🔲 open · ✅ done · ❌ blocked.
